...
* [Audiocraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,612 | 🐛 396 | 🌐 Jupyter Notebook | 📅 2026-03-03: A library for audio processing and generation with deep learning, including MusicGen, a controllable music generation LM with textual and melodic conditioning 🎧 (17044 stars)
* [Magenta](https://github.com/magenta/magenta) ⚠️ Archived: Music and Art Generation with Machine Intelligence 🎵🖌️ (18712 stars)
* [Muzic](https://github.com/microsoft/muzic) ⭐ 4,953 | 🐛 115 | 🌐 Python | 📅 2026-08-05: Music Understanding and Generation with Artificial Intelligence 🎶 (3765 stars)
...
* [**TTS WebUI**](https://github.com/rsxdalv/tts-generation-webui) ⭐ 3,254 | 🐛 131 | 🌐 TypeScript | 📅 2026-09-07 - Generative AI for Music and TTS, supporting Audiocraft, MusicGen, ACE-Step, RVC and more. 🎵 (2163 stars)
...
* [**OBSIDIAN Neural**](https://github.com/innermost47/ai-dj) ⭐ 242 | 🐛 0 | 🌐 C++ | 📅 2026-07-31: Real-time AI loop generation VST3 plugin for live performance. 🎹⚡ (150 stars)
...
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 477 | 🐛 7 | 🌐 Python | 📅 2026-09-02: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 477 | 🐛 7 | 🌐 Python | 📅 2026-09-02: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
