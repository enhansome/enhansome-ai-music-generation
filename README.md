...
* [Audiocraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,633 | 🐛 398 | 🌐 Jupyter Notebook | 📅 2026-03-03: A library for audio processing and generation with deep learning, including MusicGen, a controllable music generation LM with textual and melodic conditioning 🎧 (17044 stars)
...
* [**OBSIDIAN Neural**](https://github.com/innermost47/ai-dj) ⭐ 244 | 🐛 0 | 🌐 C++ | 📅 2026-07-31: Real-time AI loop generation VST3 plugin for live performance. 🎹⚡ (150 stars)
...
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 495 | 🐛 5 | 🌐 Python | 📅 2026-09-16: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 495 | 🐛 5 | 🌐 Python | 📅 2026-09-16: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
