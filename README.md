...
* [**TTS WebUI**](https://github.com/rsxdalv/tts-generation-webui) ⭐ 3,239 | 🐛 108 | 🌐 TypeScript | 📅 2026-07-27 - Generative AI for Music and TTS, supporting Audiocraft, MusicGen, ACE-Step, RVC and more. 🎵 (2163 stars)
...
* [**Radium**](https://github.com/kmatheussen/radium) ⭐ 1,074 | 🐛 270 | 🌐 C++ | 📅 2026-08-16: A graphical music editor and next generation tracker. 🎵⚡️ (805 stars)
...
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 428 | 🐛 3 | 🌐 Python | 📅 2026-08-16: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 428 | 🐛 3 | 🌐 Python | 📅 2026-08-16: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
