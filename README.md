...
* [Audiocraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,568 | 🐛 394 | 🌐 Jupyter Notebook | 📅 2026-03-03: A library for audio processing and generation with deep learning, including MusicGen, a controllable music generation LM with textual and melodic conditioning 🎧 (17044 stars)
* [Magenta](https://github.com/magenta/magenta) ⚠️ Archived: Music and Art Generation with Machine Intelligence 🎵🖌️ (18712 stars)
* [Muzic](https://github.com/microsoft/muzic) ⭐ 4,949 | 🐛 115 | 🌐 Python | 📅 2026-08-05: Music Understanding and Generation with Artificial Intelligence 🎶 (3765 stars)
...
* [AudioLDM2](https://github.com/haoheliu/AudioLDM2) ⭐ 2,638 | 🐛 74 | 🌐 Python | 📅 2024-09-29: Text-to-Audio/Music Generation 🎵 (1733 stars)
...
* [**Radium**](https://github.com/kmatheussen/radium) ⭐ 1,074 | 🐛 268 | 🌐 C++ | 📅 2026-08-21: A graphical music editor and next generation tracker. 🎵⚡️ (805 stars)
...
* [**OBSIDIAN Neural**](https://github.com/innermost47/ai-dj) ⭐ 240 | 🐛 0 | 🌐 C++ | 📅 2026-07-31: Real-time AI loop generation VST3 plugin for live performance. 🎹⚡ (150 stars)
...
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 438 | 🐛 5 | 🌐 Python | 📅 2026-08-20: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 438 | 🐛 5 | 🌐 Python | 📅 2026-08-20: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
