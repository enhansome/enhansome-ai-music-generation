...
* [Audiocraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,564 | 🐛 394 | 🌐 Jupyter Notebook | 📅 2026-03-03: A library for audio processing and generation with deep learning, including MusicGen, a controllable music generation LM with textual and melodic conditioning 🎧 (17044 stars)
* [Magenta](https://github.com/magenta/magenta) ⚠️ Archived: Music and Art Generation with Machine Intelligence 🎵🖌️ (18712 stars)
* [Muzic](https://github.com/microsoft/muzic) ⭐ 4,948 | 🐛 115 | 🌐 Python | 📅 2026-08-05: Music Understanding and Generation with Artificial Intelligence 🎶 (3765 stars)
...
* [**TTS WebUI**](https://github.com/rsxdalv/tts-generation-webui) ⭐ 3,238 | 🐛 109 | 🌐 TypeScript | 📅 2026-07-27 - Generative AI for Music and TTS, supporting Audiocraft, MusicGen, ACE-Step, RVC and more. 🎵 (2163 stars)
* [Mubert-Text-to-Music](https://github.com/MubertAI/Mubert-Text-to-Music) ⭐ 2,726 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2023-05-04: A notebook demonstrating prompt-based music generation using Mubert API 🎵 (2674 stars)
...
* [AudioLDM2](https://github.com/haoheliu/AudioLDM2) ⭐ 2,637 | 🐛 74 | 🌐 Python | 📅 2024-09-29: Text-to-Audio/Music Generation 🎵 (1733 stars)
...
* [musegan](https://github.com/salu133445/musegan) ⭐ 2,035 | 🐛 21 | 🌐 Python | 📅 2024-06-07: An AI for Music Generation 🎵 (1602 stars)
* [**Radium**](https://github.com/kmatheussen/radium) ⭐ 1,074 | 🐛 270 | 🌐 C++ | 📅 2026-08-19: A graphical music editor and next generation tracker. 🎵⚡️ (805 stars)
...
* [**MusicGenerator**](https://github.com/Conchylicultor/MusicGenerator) ⭐ 337 | 🐛 7 | 🌐 Python | 📅 2017-04-01: Experiment with diverse deep learning models for music generation with TensorFlow. 🎶🧪 (309 stars)
...
* [**OBSIDIAN Neural**](https://github.com/innermost47/ai-dj) ⭐ 240 | 🐛 1 | 🌐 C++ | 📅 2026-07-31: Real-time AI loop generation VST3 plugin for live performance. 🎹⚡ (150 stars)
...
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 436 | 🐛 9 | 🌐 Python | 📅 2026-08-20: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 436 | 🐛 9 | 🌐 Python | 📅 2026-08-20: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
