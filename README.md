# Awesome Music Generation with AI with stars
...
* [Audiocraft](https://github.com/facebookresearch/audiocraft) ⭐ 23,561 | 🐛 394 | 🌐 Jupyter Notebook | 📅 2026-03-03: A library for audio processing and generation with deep learning, including MusicGen, a controllable music generation LM with textual and melodic conditioning 🎧 (17044 stars)
* [Magenta](https://github.com/magenta/magenta) ⚠️ Archived: Music and Art Generation with Machine Intelligence 🎵🖌️ (18712 stars)
* [Muzic](https://github.com/microsoft/muzic) ⭐ 4,947 | 🐛 115 | 🌐 Python | 📅 2026-08-05: Music Understanding and Generation with Artificial Intelligence 🎶 (3765 stars)
...
* [musiclm-pytorch](https://github.com/lucidrains/musiclm-pytorch) ⭐ 3,296 | 🐛 26 | 🌐 Python | 📅 2023-09-06: PyTorch implementation of MusicLM, Google's state-of-the-art model for music generation using attention networks 🎼 (2763 stars)
* [**TTS WebUI**](https://github.com/rsxdalv/tts-generation-webui) ⭐ 3,236 | 🐛 108 | 🌐 TypeScript | 📅 2026-07-27 - Generative AI for Music and TTS, supporting Audiocraft, MusicGen, ACE-Step, RVC and more. 🎵 (2163 stars)
* [Mubert-Text-to-Music](https://github.com/MubertAI/Mubert-Text-to-Music) ⭐ 2,727 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2023-05-04: A notebook demonstrating prompt-based music generation using Mubert API 🎵 (2674 stars)
* [riffusion-app](https://github.com/riffusion/riffusion-app) ⭐ 2,678 | 🐛 25 | 🌐 TypeScript | 📅 2024-07-22: Stable diffusion for real-time music generation in a web app 🎵 (2474 stars)
* [AudioLDM2](https://github.com/haoheliu/AudioLDM2) ⭐ 2,638 | 🐛 73 | 🌐 Python | 📅 2024-09-29: Text-to-Audio/Music Generation 🎵 (1733 stars)
...
* [**Radium**](https://github.com/kmatheussen/radium) ⭐ 1,074 | 🐛 270 | 🌐 C++ | 📅 2026-08-13: A graphical music editor and next generation tracker. 🎵⚡️ (805 stars)
...
* [**Music Generation with Deep Learning**](https://github.com/umbrellabeach/music-generation-with-DL) ⭐ 730 | 🐛 1 | 📅 2021-08-02: Resources on music generation using deep learning. 🎶💻 (700 stars)
* [**Musika**](https://github.com/marcoppasini/musika) ⭐ 683 | 🐛 14 | 🌐 Python | 📅 2022-10-28: Fast infinite waveform music generation. 🎵💨 (646 stars)
* [**Music Generation Research**](https://github.com/AI-Guru/music-generation-research) ⭐ 606 | 🐛 1 | 📅 2025-01-20: A collection of music generation research resources. 🎶🔬 (516 stars)
* [**MusPy**](https://github.com/salu133445/muspy) ⭐ 523 | 🐛 26 | 🌐 Python | 📅 2026-03-11: A toolkit for symbolic music generation. 🎵🔧 (387 stars)
...
* [**OBSIDIAN Neural**](https://github.com/innermost47/ai-dj) ⭐ 239 | 🐛 3 | 🌐 C++ | 📅 2026-07-31: Real-time AI loop generation VST3 plugin for live performance. 🎹⚡ (150 stars)
* [**LatentScore**](https://github.com/prabal-rje/latentscore) ⭐ 41 | 🐛 1 | 🌐 Python | 📅 2026-05-29: Simple text to ambient music in Python without GPU. 🎵 (35 stars)
...
* [Generating Music With Artificial Intelligence](https://towardsdatascience.com/generating-music-with-artificial-intelligence-9ce3c9eef806) :musical\_note:
...
* [A Classifying Variational Autoencoder with Application to ...](https://arxiv.org/abs/1711.07050) :musical\_keyboard:
...
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 419 | 🐛 5 | 🌐 Python | 📅 2026-08-12: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
* [Claude AI Music Skills](https://github.com/bitwize-music-studio/claude-ai-music-skills) ⭐ 419 | 🐛 5 | 🌐 Python | 📅 2026-08-12: Claude Code plugin for full-lifecycle AI music album production — lyrics, Suno style prompts, per-stem mixing, mastering, and release distribution.
